...
<header class="header">
            <nav class="navbar">
                ...
                <ul class="ul_links">
                    ...
                    <li class="li_links">
                        <a href="insano.php" class="link  link text-decoration-none">USUARIO</a>
                    </li>
...
<h3 class="text-center text-white ">USUARIO</h3>
<?php
  ...
  <tbody>
    ...
    <tr>
        ...
        <td>
            ...
            <a onclick="return eliminar()"  href="insano.php?ID=<?= $datos->ID ?>" id="be"><i class="fa-solid fa-trash"></i></a>
        </td>
    </tr>     
    <?php } ?>
</tbody>
