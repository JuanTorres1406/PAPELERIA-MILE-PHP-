...
<header class="header">
            <nav class="navbar">
                ...
                <ul class="ul_links">
                    ...
                    <li class="li_links">
                        <a href="clientes.php" class="link text-decoration-none">CLIENTES</a>
                    </li>
                    <li class="li_links">
  ...
  <tbody>
    ...
    <tr>
        ...
        <td>
            ...
            <a onclick="return eliminar()"  href="clientes.php?ID=<?= $datos->ID ?>" id="be"><i class="fa-solid fa-trash"></i></a>
        </td>
    </tr>     
    <?php } ?>
</tbody>
