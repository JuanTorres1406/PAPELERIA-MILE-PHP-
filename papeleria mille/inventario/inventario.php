            ...
            <nav class="navbar">
                ...
                <ul class="ul_links">
                    ...
                    <li class="li_links">
                        ...
                        <li class="li_links">
                        <a href="inventario.php" class="link text-decoration-none">INVENTARIO</a>
                    </li>
                    <li class="li_links">
...
<h3 class="text-center text-white">INVENTARIO</h3>
<?php
  ...
  <tbody>
    ...
    <tr>
        ...
        <td>
            ...
            <a onclick="return eliminar()"  href="inventario.php?ID=<?= $datos->ID ?>" id="be"><i class="fa-solid fa-trash"></i></a>
        </td>
    </tr>     
    <?php } ?>
</tbody>
