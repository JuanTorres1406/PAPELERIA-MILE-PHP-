...
<header class="header">
            <nav class="navbar">
                ...
                <ul class="ul_links">
                    ...
                    <li class="li_links">
                        <a href="empleados.php" class="link text-decoration-none">EMPLEADOS</a>
                    </li>
...
<h3 class="text-center  text-white">EMPLEADOS</h3>
<?php
...
?>
  ...
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label  text-white">Edad</label>
    <input type="text" class="form-control" name="EDAD">
    
  </div>
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label  text-white">Cedula de ciudadania</label>
  ...
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label  text-white">Cargo</label>
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
        ...
        <td>
            ...
            <a onclick="return eliminar()"  href="empleados.php?ID=<?= $datos->ID ?>" id="be"><i class="fa-solid fa-trash"></i></a>
        </td>
    </tr>     
    <?php } ?>
</tbody>
  ...
  <footer>
    <div class="footerContainer">
        ...
        <div class="footerBottom   text-decoration-none">
